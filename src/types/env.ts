...
const env = object({
	TOKEN: string(),
	GUILD: string(),
	MDN_INDEX_REFRESH: optional(coerce(number([minValue(1, "Must be at least 1")]), Number)),
	SCRAPE_CACHE_LIFETIME: optional(coerce(number([minValue(0, "Must not be negative")]), Number)),
